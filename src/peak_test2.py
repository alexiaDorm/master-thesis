...
def train():
 ...
 """
        ...
        if (epoch+1)%5 == 0:
            torch.save(model.state_dict(), '../results/conv_model_1e-3.pkl')

            with open('../results/conv_train_loss_1e-3.pkl', 'wb') as file:
                    pickle.dump(train_loss, file)

            with open('../results/conv_train_KLD_1e-3.pkl', 'wb') as file:
                    pickle.dump(train_KLD, file)

            with open('../results/conv_train_MSE_1e-3.pkl', 'wb') as file:
                    pickle.dump(train_MSE, file)

            with open('../results/conv_test_KLD_1e-3.pkl', 'wb') as file:
                    pickle.dump(test_KLD, file)

            with open('../results/conv_test_MSE_1e-3.pkl', 'wb') as file:
                    pickle.dump(test_MSE, file)

            with open('../results/conv_corr_1e-3.pkl', 'wb') as file:
                    pickle.dump(corr_test, file)

            with open('../results/conv_jsd_1e-3.pkl', 'wb') as file:
