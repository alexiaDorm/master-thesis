...
cmd_tomtom = "modisco report -i modisco_results_bias.h5 -o report_bias/TOMTOM/ -s report_bias/TOMTOM/ -m ../data/JASPAR_motif.txt"
...
cmd_tomtom = "modisco report -i modisco_results_wobias.h5 -o report_bias/TOMTOM/ -s report_bias/TOMTOM/ -m ../data/JASPAR_motif.txt"
subprocess.run(cmd_tomtom, shell=True)